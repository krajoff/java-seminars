...
// Импортируем классы библиотеки assertJ
...
public class Main {
    ...
    public static void happyNY() {
        ...
        calendar1.set(2022, 0, 0, 0, 0, 0);
        calendar.getTime().before(calendar1.getTime());
        assert currentDateTime.compareTo("01/01/2022 00:00:00") > 0 : "Еще 2023 год :(";
